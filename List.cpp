...
bool List::empty() const { return _content.empty(); }
std::size_t List::size() const { return _content.size(); }
...
void List::pushBack(IObject* obj) { _content.push_back(obj); }
void List::pushFront(IObject* obj) { _content.insert(_content.begin(), obj); }
